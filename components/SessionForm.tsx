        ...
        <form action={clientAction} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              {/* Display input - shows formatted date, prevents text input */}
              <input
                type="text"
                readOnly
                value={date}
                className="relative z-[1] w-full p-4 rounded-xl bg-foreground/5 border border-foreground/10 outline-none transition-all pointer-events-none"
