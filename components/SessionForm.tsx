        ...
        <form action={clientAction} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full p-4 rounded-xl bg-foreground/5 border border-foreground/10 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all"
            />
          </div>
